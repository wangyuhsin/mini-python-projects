...
class BreakoutGraphics:
    ...
    def ball_collide_brick(self):
        if (
            self.window.get_object_at(
                self.ball.x, self.ball.y + self.ball.height)
            is not None
            and self.window.get_object_at(self.ball.x, self.ball.y + self.ball.height)
            is not self.paddle
            and self.window.get_object_at(self.ball.x, self.ball.y + self.ball.height)
            is not self.life_label
            and self.window.get_object_at(self.ball.x, self.ball.y + self.ball.height)
        ...
        if (
            self.window.get_object_at(
                self.ball.x + self.ball.width, self.ball.y)
            is not self.paddle
            and self.window.get_object_at(self.ball.x + self.ball.width, self.ball.y)
            is not None
            and self.window.get_object_at(self.ball.x + self.ball.width, self.ball.y)
            is not self.life_label
            and self.window.get_object_at(self.ball.x + self.ball.width, self.ball.y)
        ...
        if (
            self.window.get_object_at(
                self.ball.x, self.ball.y) is not self.paddle
            and self.window.get_object_at(self.ball.x, self.ball.y) is not None
            and self.window.get_object_at(self.ball.x, self.ball.y)
            is not self.life_label
            and self.window.get_object_at(self.ball.x, self.ball.y)
            is not self.score_label
        ):
    ...
    def lose(self):
        ...
        self.window.add(
            lose_label,
            self.window.width / 2 - lose_label.width / 2,
            self.window.height / 2.5,
        )
        self.window.add(
            self.score_label,
            (self.window_width - self.score_label.width) / 2,
            lose_label.y + 50,
        )
    ...
    def win(self):
        ...
        self.window.add(
            win_label,
            self.window.width / 2 - win_label.width / 2,
            self.window.height / 2.5,
        )
        self.window.add(
            self.score_label,
